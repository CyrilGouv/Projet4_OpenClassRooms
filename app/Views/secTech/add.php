        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="admin-espace-content">
                    ...
                    <a class="active" href="<?= URL_ROOT ?>/sectech/add">Ajouter un article</a>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="add-post text-left">
                    ...
                    <form action="<?= URL_ROOT ?>/sectech/add" method="post" enctype="multipart/form-data">

                        <div class="form-group add-post-title">
                            <label for="post-title">Titre : <sup>*</sup></label>
                            <input type="text" name="postTitle" class="form-control <?= (!empty($data['titleError'])) ? 'is-invalid' : '' ?>">
                            <span class="invalid-feedback"><?= $data['titleError'] ?></span>
                        </div>

                        <div class="form-group add-post-image">
                            <label for="post-image">Image à la une : <sup>*</sup></label>
                            <input type="file" name="postImage" class="form-control  <?= (!empty($data['imageError'])) ? 'is-invalid' : '' ?>">
                            <span class="invalid-feedback"><?= $data['imageError'] ?></span>
                        </div>

                        <div class="form-group add-post-content">
                            <label for="post-content">Contenu : <sup>*</sup></label>
                            <textarea class="form-control <?= (!empty($data['contentError'])) ? 'is-invalid' : '' ?>" name="postContent" rows="10"></textarea>
                            <span class="invalid-feedback"><?= $data['contentError'] ?></span>
                        </div>
